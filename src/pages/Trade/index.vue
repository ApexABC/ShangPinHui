<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="address in addressInfo" :key="address.userId">
...
export default {
  ...
  computed: {
    ...mapState({ addressInfo: state => state.trade.addressInfo, tradeInfo: state => state.trade.tradeInfo }),
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        ...
        paymentWay: 'ONLINE', //支付放肆
        orderComment: this.msg, //支付备注
        orderDetailList: this.detailArrayList //货物清单
      }
      // 提交订单
      try {
